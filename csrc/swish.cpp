...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  m.def("swish_forward", &swish_forward, "Swish activation forward", "input"_a, "out"_a = nullptr);
  m.def("swish_backward", &swish_backward, "Swish activation backward", "input"_a, "grad_out"_a);
}
